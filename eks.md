...
Note that the `transformations` property is available only with the “v1” version of `ConfigFile` and `ConfigGroup`; for the “v2” version, use the `transforms` option.
